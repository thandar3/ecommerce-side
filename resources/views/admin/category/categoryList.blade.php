                        ...
                        <div class="table-data__tool">
                            <div class="table-data__tool-left">
                                <div class="overview-wrap">
                                    ...
                                    <h4 class="ms-3 border-sm total">Total categories - {{ count($categories) }}
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div class="flex_container">
                            @foreach ($categories as $category)
                                <div class="flex_box">
                                    ...
                                    <h5>Category created date -
                                        {{ $category->created_at->format('j-F-Y') }}

                                        <div class="mt-3">
                                            <a href="{{ route('category#delete', $category->id) }}" class="me-4  ">
                                                <button><i class="fa-regular fa-trash-can text-danger"></i></button>
                                            </a>
                                            <a href="{{ route('category#edit', $category->id) }}" class="me-4">
